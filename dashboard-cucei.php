 ...
 <br><br>
  ...
  <section id="reportes" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h3 class="ser-title" id="nombreAcademicoPersonal" style="color: white"></h3>
  ...
  <section id="misDatos" class="section-padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12">
          <p style="color: white">Correo Electrónico: <b><span id="correoAcademicoPersonal"></span></b></p>
          <p style="color: white">Número Celular: <b><span id="celularAcademicoPersonal"></span></b></p>
          <p style="color: white"><small>El uso del número celular es en caso de ser contactado por el área de seguridad y mantenimiento interno de CUCEI.</small></p>
