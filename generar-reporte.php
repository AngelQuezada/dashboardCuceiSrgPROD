      ...
      <form name="formulario" autocomplete="off">
                ...
                <div class="input-field col-sm-12">
                  <fieldset>
                    ...
                    <select class="form-control" id="modulo" onclick="getModulo()"></select>
                    <a href="#" onclick="ereaseModule()">Cambiar</a><br>
                    <label for="piso">Piso:</label>
                    <select class="form-control" id="piso" 
                    onclick="getPiso()"></select>
                    <a href="#" onclick="ereaseFloor()">Cambiar</a><br>
                    <label for="aula">Aula:</label>
                    <select class="form-control" id="aula"
                    onclick="getAula()" 
                    ></select>
                    <a href="#" onclick="ereaseAula()">Cambiar</a><br>
                    <a href="#" onclick="ereaseItems()">Reiniciar</a>
                  </fieldset>
                </div>
                <div class="input-field col-sm-12">
                    <fieldset>
