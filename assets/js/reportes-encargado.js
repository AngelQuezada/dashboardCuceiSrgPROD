...
let reportesTodos = () => {
    ...
    $.ajax({
        ...
        success: function (data) {
          ...
          <td><button class="btn btn-primary" id="btnVerReporte" data-toggle="modal" data-target="#myModal" onclick="verReporte('` + registro.folioReporte + `','` + this + `')"><i class="fa fa-external-link" aria-hidden="true"></i></button></td>
          </tr>
          `);
            });
